...
public class StackWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.auzan.cataloguemovieuiux.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.auzan.cataloguemovieuiux.EXTRA_ITEM";
