...
import com.example.sub1_cataloguemovie.utils.DailyReminderReceive;
import com.example.sub1_cataloguemovie.utils.UpcomingReminderReceive;
...
public class MyPreferenceFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        ...
        if (key.equals(reminder_daily)) {
            if (isOn) {
                dailyReminderReceive.setRepeatingAlarm(getContext());
            } else {
